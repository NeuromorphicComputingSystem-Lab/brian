...
while j < (int(num_examples)):
    ...
    if np.sum(current_spike_count) < SPIKE_THRESH:
       ...
       if(test_mode and use_testing_set):
          ...
          if((not test_mode) and (np.sum(neuron_groups['e'].I_ipost)==0)):
